...
export default function NonStreamingChatWrapper({ messageHistroyResult }: { success: boolean; data: { chatId: string; role: string; content: string; id: string; createdAt: Date; }[]; error?: undefined; }) {
  ...
  // 这是非 streaming 版本的 handleSend，先发送用户消息，再等待 AI 回复，最后一起更新到数据库和界面
